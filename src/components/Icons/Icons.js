...
export const MapIcon = ({ width = '3.2rem', height = '3.2rem', className }) => (
    <svg
        className={className}
        fill="currentColor"
        width={width}
...
export const MapActiveIcon = ({ width = '3.2rem', height = '3.2rem', className }) => (
    <svg
        className={className}
        fill="currentColor"
        width={width}
...
export const UserExitIcon = ({ width = '2.4rem', height = '2.4rem', className }) => (
    <svg
        className={className}
        fill="currentColor"
        width={width}
...
export const UseExitActiveIcon = ({ width = '2.4rem', height = '2.4rem', className }) => (
    <svg
        className={className}
        fill="currentColor"
        width={width}
